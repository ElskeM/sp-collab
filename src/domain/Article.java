...
public class Article implements Serializable {
	...
	private int stock; // Perhaps better with a warehouse entity that holds the stock. Stock does not
						// "belong" to article
	...
	public String toString() {
		return "Article number: " + artNr + " | name: " + name + " | description: " + description + " | price: "
				+ price;
	}
